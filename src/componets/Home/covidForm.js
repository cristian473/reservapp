        ...
        >
            <div className="covidFormContainer">
                <div className="text">
                    ...
                    <p><strong style={{ color: 'rgb(51, 51, 51)' }}>4)</strong><span style={{ color: 'rgb(51, 51, 51)' }}>En los últimos 14 días, ¿recibiste un diagnóstico confirmado “positivo” de COVID19 o has sido evaluado por la evaluación clínica médica como “caso sospechoso” de COVID19 y estás en la espera de la prueba de laboratorio respectiva?</span></p>
                    <br />
